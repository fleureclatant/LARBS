...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/fleureclatant/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/fleureclatant/LARBS/master/progs.csv"
